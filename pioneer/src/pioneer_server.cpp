...
else
{
 ...
 res.result = "Success! Moved the pioneer base to the object";
...
int main(int argc, char **argv)
{
 ...
 ros::NodeHandle n; 
 pub = n.advertise<geometry_msgs::Twist>("/RosAria/cmd_vel",100); // "packagename*/cmd_vel" topic with message type "geometry_msgs/twist"
